            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Full Stack Graphic Design course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Graphic Design Expert
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Master Design Fundamentals", description: "Learn typography, color theory, and visual hierarchy." },
                            { title: "Adobe & Design Tools", description: "Get hands-on experience with Photoshop, Illustrator, Figma, and more." },
                            { title: "UI/UX & Web Design", description: "Create intuitive user interfaces and enhance user experiences." },
                            { title: "Branding & Digital Marketing", description: "Develop brand identity and design assets for marketing campaigns." }
                        ].map((step, index) => (
