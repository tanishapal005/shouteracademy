            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Flutter Development course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Flutter Developer
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    ...
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn Flutter Basics", description: "Get started with Dart and understand Flutter’s framework." },
                            { title: "Build UI Components", description: "Create beautiful and responsive UIs using Flutter widgets." },
                            { title: "State Management & Navigation", description: "Master state management techniques and efficient app navigation." },
                            { title: "Deploy & Optimize", description: "Publish your app on Play Store & App Store and optimize performance." }
                        ].map((step, index) => (
