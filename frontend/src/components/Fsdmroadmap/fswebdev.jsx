            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Full Stack Web Development course work?
                    </h2>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn", description: "Master front-end and back-end technologies from industry experts." },
                            { title: "Practice", description: "Work on real-world coding exercises, projects, and assignments." },
                            { title: "Ask", description: "Get expert mentorship and one-on-one doubt-clearing sessions." },
                            { title: "Build", description: "Create full-stack applications and develop a strong portfolio." }
                        ].map((step, index) => (
...
export default FullStackWebDevRoadmap;
