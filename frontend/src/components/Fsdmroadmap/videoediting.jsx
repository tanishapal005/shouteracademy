            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Video Editing course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Professional Video Editor
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn Video Editing Basics", description: "Understand timeline editing, cutting, and trimming techniques." },
                            { title: "Master Editing Software", description: "Use Adobe Premiere Pro, Final Cut Pro, and DaVinci Resolve." },
                            { title: "Apply Effects & Transitions", description: "Enhance videos with motion graphics, color grading, and animations." },
                            { title: "Export & Optimize", description: "Learn video compression, formats, and exporting for different platforms." }
                        ].map((step, index) => (
