            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this LAMP Stack Development course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a LAMP Stack Developer
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn Linux & Apache", description: "Understand server setup, configurations, and hosting using Linux and Apache." },
                            { title: "Master PHP & MySQL", description: "Develop dynamic web applications with PHP and manage data with MySQL." },
                            { title: "Practice Backend Development", description: "Build secure and scalable backend systems with PHP and databases." },
                            { title: "Deploy & Optimize", description: "Deploy applications on live servers and optimize performance for scalability." }
                        ].map((step, index) => (
...
export default LampStackRoadmap;