            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Cloud Computing course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Cloud Computing Professional
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    ...
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Cloud Fundamentals", description: "Understand cloud concepts, services, and deployment models." },
                            { title: "Networking & Security", description: "Learn cloud networking, security best practices, and compliance." },
                            { title: "Cloud Platforms & Tools", description: "Explore AWS, Azure, and Google Cloud for real-world applications." },
                            { title: "Capstone Project & Job Readiness", description: "Work on a cloud-based project and prepare for job roles." }
                        ].map((step, index) => (
