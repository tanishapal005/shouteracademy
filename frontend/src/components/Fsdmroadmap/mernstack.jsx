            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this MERN Stack Development course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a MERN Stack Developer
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn JavaScript & React", description: "Master JavaScript and React.js for building powerful front-end applications." },
                            { title: "Understand Node.js & Express", description: "Develop robust backend applications using Node.js and Express.js." },
                            { title: "Work with MongoDB", description: "Learn how to store and manage data efficiently using MongoDB." },
                            { title: "Deploy & Scale", description: "Deploy your MERN applications and optimize performance for scalability." }
                        ].map((step, index) => (
