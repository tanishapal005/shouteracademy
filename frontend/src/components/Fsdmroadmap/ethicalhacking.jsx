            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Ethical Hacking course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Certified Ethical Hacker
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn Fundamentals", description: "Understand cybersecurity concepts, networking, and system vulnerabilities." },
                            { title: "Hands-On Practice", description: "Work with real-world hacking tools and penetration testing labs." },
                            { title: "Ethical Exploitation", description: "Identify security loopholes and ethically exploit them to strengthen systems." },
                            { title: "Certification & Career", description: "Prepare for CEH, OSCP, and other industry-recognized certifications." }
                        ].map((step, index) => (
