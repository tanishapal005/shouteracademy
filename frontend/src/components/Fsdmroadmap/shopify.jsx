            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Shopify Development course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Shopify Developer
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn Shopify Basics", description: "Understand Shopify store setup, themes, and settings." },
                            { title: "Customize Themes", description: "Modify Shopify themes using Liquid, HTML, CSS, and JavaScript." },
                            { title: "Extend with Apps", description: "Develop and integrate Shopify apps to enhance store functionality." },
                            { title: "Optimize & Scale", description: "Improve store speed, SEO, and conversion rates for better sales." }
                        ].map((step, index) => (
