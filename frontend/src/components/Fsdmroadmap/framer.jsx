            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this Framer Development course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a Framer Expert
                    </p>
                </div>

                {/* Mobile Layout (Without Images) */}
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Learn Framer Basics", description: "Get familiar with Framer’s interface, components, and workflow." },
                            { title: "Design Interactive UI", description: "Create stunning UI/UX designs with interactive animations and effects." },
                            { title: "Prototype & Test", description: "Develop high-fidelity prototypes and test user interactions effortlessly." },
                            { title: "Launch & Optimize", description: "Deploy projects and optimize for speed, responsiveness, and accessibility." }
                        ].map((step, index) => (
