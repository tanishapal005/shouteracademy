            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this WordPress Development course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a WordPress Developer
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[ 
                            { title: "Learn WordPress Basics", description: "Understand WordPress installation, themes, and plugins." },
                            { title: "Customize with Themes & Plugins", description: "Modify themes and extend functionality with plugins." },
                            { title: "Master Page Builders", description: "Use Elementor, Divi, and other builders to create stunning designs." },
                            { title: "Optimize & Secure", description: "Speed up websites, improve SEO, and enhance security." }
                        ].map((step, index) => (
...
export default WordPressRoadmap;
