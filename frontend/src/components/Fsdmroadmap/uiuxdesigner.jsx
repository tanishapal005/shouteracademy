            ...
            <div className="max-w-4xl w-full relative">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-lg md:text-xl font-semibold">
                        How does this UI/UX Design course work?
                    </h2>
                    <p className="text-gray text-sm md:text-base">
                        Your Roadmap to Becoming a UI/UX Designer
                    </p>
                </div>
                ...
                <div className="flex flex-col md:hidden items-center">
                    <div className="w-full max-w-4xl flex flex-col items-center space-y-6">
                        {[
                            { title: "Understand UX Principles", description: "Learn user psychology, research, and usability testing." },
                            { title: "Master UI Design Tools", description: "Work with Figma, Adobe XD, and Sketch for interface design." },
                            { title: "Design Prototypes & Wireframes", description: "Create interactive wireframes and high-fidelity prototypes." },
                            { title: "Build Real-World UI/UX Projects", description: "Work on case studies and design systems for practical experience." }
                        ].map((step, index) => (
