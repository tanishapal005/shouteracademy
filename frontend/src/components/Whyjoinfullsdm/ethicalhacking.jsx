...
const WhoShouldJoinEthicalHacking = () => {
    return (
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-11 bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join Ethical Hacking Course by
                    ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring Ethical Hackers" }, { img: img2, text: "Cybersecurity Enthusiasts" }, { img: img3, text: "IT Professionals" }, { img: img4, text: "Students & Freshers" }, { img: img5, text: "Penetration Testers" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    Ethical hacking is a crucial skill for cybersecurity professionals to protect networks, systems, and sensitive data. 
                    Learning ethical hacking can help you prevent cyber threats, conduct penetration testing, and build a successful career in cybersecurity.
                </p>
            </div>
...
export default WhoShouldJoinEthicalHacking;
