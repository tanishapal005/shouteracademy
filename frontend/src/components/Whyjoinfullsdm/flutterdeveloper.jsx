        ...
        <div className="flex flex-col mb-11 lg:flex-row justify-between items-center bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join the Flutter Development Program by ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring App Developers" }, { img: img2, text: "UI/UX Designers" }, { img: img3, text: "Mobile App Engineers" }, { img: img4, text: "Freelance Developers" }, { img: img5, text: "Tech Entrepreneurs" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    Flutter is revolutionizing mobile app development, enabling developers to build high-performance, cross-platform applications with a single codebase. 
                    Whether you're an aspiring app developer, a UI/UX designer wanting to enhance your skills, or an entrepreneur aiming to create seamless digital experiences, mastering Flutter opens doors to endless opportunities.
                </p>
            </div>
...
export default WhoShouldJoinFlutter;