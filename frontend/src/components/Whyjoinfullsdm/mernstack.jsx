        ...
        <div className="flex flex-col lg:flex-row justify-between items-center  mb-11 bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join MERN Stack Development Course by
                    ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring MERN Developers" }, { img: img2, text: "JavaScript Enthusiasts" }, { img: img3, text: "Front-end Developers" }, { img: img4, text: "Backend Beginners" }, { img: img5, text: "Tech Entrepreneurs" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    The MERN stack is one of the most popular full-stack development technologies. Companies are constantly looking for skilled developers proficient in MongoDB, Express.js, React, and Node.js.
                    Mastering the MERN stack allows you to build scalable, high-performance web applications and opens up excellent career opportunities.
                </p>
            </div>
            ...
            <div className="w-full md:w-96 h-auto p-4 border-2 border-gray rounded-xl shadow-lg relative mt-6 lg:mt-0">
                <img
                    src={img1}
                    alt="MERN Stack Development Team"
...
export default WhoShouldJoinMERN;
