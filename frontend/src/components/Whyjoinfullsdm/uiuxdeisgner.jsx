        ...
        <div className="flex flex-col lg:flex-row justify-between items-center bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join UI/UX Design Course by
                    ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring UI Designers" }, { img: img2, text: "UX Enthusiasts" }, { img: img3, text: "Product Designers" }, { img: img4, text: "Graphic Designers" }, { img: img5, text: "Freelance Designers" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    UI/UX design is a critical skill for creating user-friendly, visually appealing, and engaging digital experiences. 
                    Mastering UI/UX helps designers craft seamless interfaces, improve user interactions, and enhance overall digital products used in businesses, startups, and freelancing.
                </p>
            </div>
...
export default WhoShouldJoinUIUX;
