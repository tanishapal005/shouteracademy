...
const WhoShouldJoinGraphicDesign = () => {
    return (
        ...
        <div className="flex flex-col mb-11 lg:flex-row justify-between  items-center bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join the Graphic Design Course by ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring Graphic Designers" }, 
                      { img: img2, text: "Creative Artists" }, 
                      { img: img3, text: "Branding Specialists" }, 
                      { img: img4, text: "UI/UX Designers" }, 
                      { img: img5, text: "Freelance Designers" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    The Graphic Design course equips you with essential skills in Adobe Photoshop, Illustrator, and Figma. 
                    Learn to create stunning visual designs, branding materials, and digital assets for businesses, startups, and freelance clients.
                </p>
            </div>
...
export default WhoShouldJoinGraphicDesign;
