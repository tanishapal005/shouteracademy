        ...
        <div className="flex flex-col lg:flex-row justify-between items-center  mb-11 bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join Shopify Development Course by
                    ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring Shopify Developers" }, { img: img2, text: "E-commerce Entrepreneurs" }, { img: img3, text: "Freelancers & Agencies" }, { img: img4, text: "Web Designers" }, { img: img5, text: "Digital Marketers" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    Shopify is one of the leading e-commerce platforms, enabling businesses to set up and manage online stores efficiently. 
                    Learning Shopify development allows you to create custom themes, apps, and optimize online stores for better sales and user experience.
                </p>
            </div>
...
export default WhoShouldJoinShopify;
