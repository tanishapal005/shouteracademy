...
const WhoShouldJoinAndroid = () => {
    return (
        <div className="bg-white  py-2">
        <div className="flex flex-col lg:flex-row justify-between items-center bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            {/* Left Section */}
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join Android Development with Kotlin Course by ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[
                        { img: img6, text: "Aspiring App Developers" },
                        { img: img2, text: "Kotlin Enthusiasts" },
                        { img: img3, text: "Mobile UI Designers" },
                        { img: img4, text: "Android Engineers" },
                        { img: img5, text: "Freelance Developers" }
                    ].map((item, index) => (
                ...
                <p className="text-sm text-black">
                    Android Development with Kotlin is the key to building high-performance, modern mobile applications.  
                    Mastering Kotlin allows developers to create scalable, efficient, and user-friendly Android apps that are in high demand in the industry.
                </p>
            </div>
...
export default WhoShouldJoinAndroid;
