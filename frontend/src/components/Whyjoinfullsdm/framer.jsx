        ...
        <div className="flex flex-col lg:flex-row justify-between items-center  mb-11 bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join Framer Development Course by
                    ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "UI/UX Designers" }, { img: img2, text: "Web Developers" }, { img: img3, text: "Creative Professionals" }, { img: img4, text: "Freelancers & Agencies" }, { img: img5, text: "Startup Founders" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    Framer is an advanced design and prototyping tool that empowers designers and developers to create high-quality interactive websites. 
                    Learning Framer helps you build modern, responsive, and animated websites with ease, combining design and development seamlessly.
                </p>
            </div>
...
export default WhoShouldJoinFramer;
