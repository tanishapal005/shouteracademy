        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-11 bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join SEO Mastery Program by ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[
                        { img: img6, text: "Aspiring SEO Specialists" },
                        { img: img2, text: "Content Marketers" },
                        { img: img3, text: "Business Owners" },
                        { img: img4, text: "Digital Marketers" },
                        { img: img5, text: "Freelancers & Bloggers" }
                    ].map((item, index) => (
                ...
                <p className="text-sm text-black">
                    SEO (Search Engine Optimization) is essential for driving organic traffic and improving website visibility on search engines like Google. Learn on-page and off-page SEO strategies, keyword research, technical SEO, and analytics to rank higher and grow your online presence effectively.
                </p>
            </div>
            ...
            <div className="w-full md:w-96 h-auto p-4 border-2 border-gray rounded-xl shadow-lg relative mt-6 lg:mt-0">
                <img
                    src={img1}
                    alt="SEO Professionals Optimizing Websites"
...
export default WhoShouldJoinSEOProgram;