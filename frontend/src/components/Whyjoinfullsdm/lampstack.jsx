        ...
        <div className="flex flex-col lg:flex-row justify-between  mb-11 items-center bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join LAMP Stack Development Course by
                    ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[{ img: img6, text: "Aspiring Web Developers" }, { img: img2, text: "PHP Enthusiasts" }, { img: img3, text: "Backend Engineers" }, { img: img4, text: "Database Administrators" }, { img: img5, text: "Freelance Developers" }]
                        .map((item, index) => (
                ...
                <p className="text-sm text-black">
                    The LAMP stack (Linux, Apache, MySQL, PHP) is a powerful combination for building dynamic and secure web applications. 
                    Mastering LAMP allows developers to create scalable, high-performance applications widely used in businesses, startups, and freelancing.
                </p>
            </div>
            ...
            <div className="w-full md:w-96 h-auto p-4 border-2 border-gray rounded-xl shadow-lg relative mt-6 lg:mt-0">
                <img
                    src={img1}
                    alt="LAMP Stack Development Team"
...
export default WhoShouldJoinLAMP;
