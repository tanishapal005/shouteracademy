...
const WhoShouldJoinCloudComputing = () => {
    return (
        ...
        <div className="flex flex-col mb-11 lg:flex-row justify-between items-center bg-white p-6 md:p-10 mt-12 mx-4 md:mx-7 border-b-4 rounded-xl shadow-lg border border-red">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold mb-4">
                    Who Should Join Cloud Computing Program by ShouterAcademy?
                </h1>

                {/* Image Categories */}
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mb-6 mt-6">
                    {[
                        { img: img6, text: "Aspiring Cloud Engineers" },
                        { img: img2, text: "DevOps Professionals" },
                        { img: img3, text: "System Administrators" },
                        { img: img4, text: "Software Developers" },
                        { img: img5, text: "IT Professionals" }
                    ].map((item, index) => (
                ...
                <p className="text-sm text-black">
                    The Cloud Computing program provides hands-on experience with AWS, Azure, and Google Cloud.  
                    Master cloud deployment, security, and automation to build scalable applications and advance your career in the cloud industry.
                </p>
            </div>
...
export default WhoShouldJoinCloudComputing;
