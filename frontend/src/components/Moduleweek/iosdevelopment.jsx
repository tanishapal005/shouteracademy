  ...
  return (
    <div className="bg-white p-6 md:p-10 rounded-lg shadow-lg border border-gray max-w-7xl mx-auto">
      ...
      <div className="mt-5 text-black">
        <h2 className="text-2xl md:text-3xl font-bold">iOS Development with Swift</h2>
        <p className="text-gray mt-2">
          Learn to build high-performance iOS applications using **Swift** and **SwiftUI**. 
          Master UI design, state management, animations, and backend integration for scalable and engaging mobile apps.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        ...
        <span className="bg-green-1 text-green px-3 py-1 rounded-md text-sm flex items-center gap-2">
          <BsJournalBookmark /> SwiftUI & UI Frameworks
        </span>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="bg-gray-1 p-4 rounded-lg shadow">
          ...
          <h4 className="text-xl font-semibold mt-3">Introduction to Swift & Xcode</h4>
          <ul className="text-gray mt-2 list-disc pl-5 text-sm">
            <li>Understanding Swift Basics</li>
            <li>Setting Up Xcode & iOS Simulator</li>
            <li>Building Your First iOS App</li>
            <li>UIKit vs. SwiftUI: Choosing the Right Approach</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-1 p-4 rounded-lg shadow">
          ...
          <ul className="text-gray mt-2 list-disc pl-5 text-sm">
            <li>Working with SwiftUI Views & Modifiers</li>
            <li>State Management & Data Flow</li>
            <li>NavigationStack & NavigationLinks</li>
        ...
        <div className="bg-gray-1 p-4 rounded-lg shadow">
          ...
          <ul className="text-gray mt-2 list-disc pl-5 text-sm">
            ...
            <li>Managing Local Data with Core Data</li>
      ...
      <div className="bg-gray-1 p-5 rounded-lg shadow mt-8 flex items-center gap-4">
        ...
        <div>
          <h3 className="text-xl font-semibold">Full-Stack iOS Mobile App</h3>
          <p className="text-gray text-sm">
            Build a fully functional **iOS mobile app** integrating Firebase backend, state management,
            and advanced UI components using Swift and SwiftUI.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-1 p-5 rounded-lg shadow mt-6">
        <h3 className="text-xl font-semibold">Advanced iOS Development Techniques</h3>
        <p className="text-gray text-sm mt-2">
          Explore best practices for Swift animations, performance optimizations, and
