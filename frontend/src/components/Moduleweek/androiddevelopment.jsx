  ...
  return (
    <div className="bg-white p-6 md:p-10 rounded-lg shadow-lg border border-gray max-w-7xl mx-auto">
      ...
      <div className="mt-5 text-black">
        <h2 className="text-2xl md:text-3xl font-bold">Android Development with Kotlin</h2>
        <p className="text-gray mt-2">
          Learn to build powerful and modern Android applications using **Kotlin**. 
          Master UI design, state management, animations, and backend integration for scalable and high-performance mobile apps.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        ...
        <span className="bg-green-1 text-green px-3 py-1 rounded-md text-sm flex items-center gap-2">
          <BsJournalBookmark /> Jetpack Compose & UI Frameworks
        </span>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="bg-gray-1 p-4 rounded-lg shadow">
          ...
          <h4 className="text-xl font-semibold mt-3">Introduction to Kotlin & Android Studio</h4>
          <ul className="text-gray mt-2 list-disc pl-5 text-sm">
            <li>Understanding Kotlin Basics</li>
            <li>Setting Up Android Studio</li>
            <li>Building Your First Android App</li>
            <li>Android UI Components & Layouts</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-1 p-4 rounded-lg shadow">
          ...
          <ul className="text-gray mt-2 list-disc pl-5 text-sm">
            ...
            <li>State Management in Android Apps</li>
            <li>Navigation & Routing in Kotlin</li>
        ...
        <div className="bg-gray-1 p-4 rounded-lg shadow">
          ...
          <ul className="text-gray mt-2 list-disc pl-5 text-sm">
            ...
            <li>Managing Local Storage with SharedPreferences & Room</li>
      ...
      <div className="bg-gray-1 p-5 rounded-lg shadow mt-8 flex items-center gap-4">
        ...
        <div>
          <h3 className="text-xl font-semibold">Full-Stack Android Mobile App</h3>
          <p className="text-gray text-sm">
            Build a fully functional **Android mobile app** integrating Firebase backend, state management,
            and advanced UI components using Kotlin and Jetpack Compose.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-1 p-5 rounded-lg shadow mt-6">
        <h3 className="text-xl font-semibold">Advanced Android Development Techniques</h3>
        <p className="text-gray text-sm mt-2">
          Explore best practices for Android animations, performance optimizations, and
