...
const founder = {
  ...
  image: kushagraImage,
  description:
    "Visionary leader with 10+ years in digital transformation and tech education.",
};
...
const TeamGrid = () => {
  ...
  const prevSlide = () =>
    setIndex((prev) => (prev === 0 ? mentors.length - visibleItems : prev - 1));
  const nextSlide = () =>
    setIndex((prev) => (prev + 1) % (mentors.length - visibleItems + 1));
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          Learn from industry leaders in UI/UX design and product experience
        </motion.h3>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
              ...
              >
                <div className="rounded-full bg-white p-1 h-full w-full">
                  ...
                  >
                    ...
                    {/* Overlay */}
                    {isFounderHovered && (
                      <motion.div className="absolute inset-0 bg-black/20 flex items-end justify-center pb-6">
                        <motion.div
          ...
          <div className="relative w-full lg:w-auto lg:flex-1">
            ...
            <div className="flex justify-center mt-6 space-x-2">
              {Array.from({ length: mentors.length - visibleItems + 1 }).map(
                (_, i) => (
                  <button
                    key={i}
                    onClick={() => setIndex(i)}
