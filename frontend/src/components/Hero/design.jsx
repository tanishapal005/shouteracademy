import Digitalmpageimg from "../../assets/images/Hero/designimg.webp"; // Import Image
    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between items-center p-6 space-y-6 lg:space-y-0 lg:space-x-6">
            ...
            <div className="max-w-2xl text-center lg:text-left">
                <h1 className="text-3xl sm:text-4xl font-bold mb-6">Get Job-ready for Designer Roles</h1>
