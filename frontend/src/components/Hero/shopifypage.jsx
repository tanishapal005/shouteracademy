    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Build & Scale Your Online Store with Shopify
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn to create, customize, and manage Shopify stores to launch and grow a successful eCommerce business.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "30,000+", label: "Students Trained" },
            { count: "2,500+", label: "Live Shopify Stores Built" },
            { count: "200+", label: "Expert Shopify Developers" },
          ].map((stat, index) => (
            <motion.div
              key={index}
