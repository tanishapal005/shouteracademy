    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Master UI/UX Design and Build Stunning Digital Experiences
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn the principles of user-centered design, wireframing, prototyping, and interface aesthetics to create seamless digital experiences.
        </p>
        ...
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            ...
            { count: "2000+", label: "Live Projects Delivered" },
            { count: "40+", label: "Expert Mentors" },
          ].map((stat, index) => (
            <motion.div
              key={index}
