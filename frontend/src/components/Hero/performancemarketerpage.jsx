    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Become a Performance Marketing Expert & Scale Your Business
        </h1>
        <p className="text-base md:text-lg mb-8">
          Master paid advertising, conversion optimization, and analytics to create high-performing marketing campaigns that drive results.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "1.2 Lakh+", label: "Marketers Trained" },
            { count: "1500+", label: "Successful Campaigns Executed" },
