    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Master WordPress & Build Powerful Websites
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn how to create, customize, and manage websites with WordPress – the most popular CMS in the world.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "50,000+", label: "Students Enrolled" },
            { count: "500+", label: "Live WordPress Projects" },
            { count: "100+", label: "Expert Mentors" },
          ].map((stat, index) => (
            <motion.div
              key={index}
