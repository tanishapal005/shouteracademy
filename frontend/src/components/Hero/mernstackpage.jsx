    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Master the MERN Stack & Build Scalable Web Applications
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn MongoDB, Express.js, React, and Node.js with hands-on projects and expert guidance.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "10,000+", label: "Developers Trained" },
            { count: "500+", label: "Real-World Projects Built" },
            { count: "50+", label: "Expert Mentors" },
          ].map((stat, index) => (
            <motion.div
              key={index}
