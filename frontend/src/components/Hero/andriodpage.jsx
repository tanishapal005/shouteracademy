    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Become an Expert in Android Development with Kotlin
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn Kotlin, Jetpack Compose, and modern Android development techniques to build high-performance mobile applications.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "50,000+", label: "Android Developers Trained" },
            { count: "2000+", label: "Live Apps Deployed" },
            { count: "100+", label: "Industry Projects" },
          ].map((stat, index) => (
            <motion.div
              key={index}
