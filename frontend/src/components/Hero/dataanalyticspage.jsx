    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Master Data Analytics and Unlock Insights from Data
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn Python, SQL, Power BI, and Machine Learning to analyze and visualize data for impactful decision-making.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "75,000+", label: "Students Trained" },
            { count: "5000+", label: "Industry Projects Completed" },
            { count: "120+", label: "Expert Mentors" },
          ].map((stat, index) => (
            <motion.div
              key={index}
