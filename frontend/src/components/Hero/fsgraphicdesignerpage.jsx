    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Become a Professional Graphic Designer & Master Creative Skills
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn Adobe Photoshop, Illustrator, and Figma to craft visually stunning designs. Enhance your creativity and build a strong portfolio.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "50,000+", label: "Designers Trained" },
            { count: "2000+", label: "Live Projects Completed" },
            { count: "40+", label: "Industry Experts" },
          ].map((stat, index) => (
            <motion.div
              key={index}
