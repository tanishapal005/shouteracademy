    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Master Video Editing & Create Stunning Visual Content
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn advanced video editing techniques using industry-leading tools and bring your creative vision to life.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "50K+", label: "Students Trained" },
            { count: "1200+", label: "Edited Projects Completed" },
            { count: "20+", label: "Industry Experts" },
          ].map((stat, index) => (
            <motion.div
              key={index}
