    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold mb-6">
          Become a Professional Flutter Developer & Build Cross-Platform Apps
        </h1>
        <p className="text-base md:text-lg mb-8">
          Learn Dart, Flutter, and Firebase to create stunning mobile applications. Gain hands-on experience and build real-world projects.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-8">
          {[ 
            { count: "30,000+", label: "Developers Trained" },
            { count: "1500+", label: "Live Projects Deployed" },
            { count: "50+", label: "Industry Experts" },
          ].map((stat, index) => (
            <motion.div
              key={index}
