    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-between px-6 md:px-16 pt-10 overflow-hidden">
      ...
      >
        ...
        <p className="text-base md:text-lg mb-8">
          Learn penetration testing, vulnerability assessment, and ethical hacking techniques to secure digital assets.
        </p>

        {/* Stats Section */}
        <div className="flex flex-wrap justify-center text-black md:justify-start space-x-4 md:space-x-8">
          {[
            { count: "20,000+", label: "Students Trained" },
            { count: "1,500+", label: "Live Cybersecurity Projects" },
            { count: "100+", label: "Certified Ethical Hackers" },
          ].map((stat, index) => (
            <motion.div
              key={index}
