...
const FAQSectionEthicalHacking = () => {
  ...
  const faqs = [
    {
      question: "What is the Ethical Hacking course?",
      answer:
        "The Ethical Hacking course teaches cybersecurity fundamentals, penetration testing, vulnerability assessment, and ethical hacking techniques.",
    },
    {
    ...
    },
    {
      ...
      answer: "Basic programming knowledge is helpful but not mandatory. The course covers necessary scripting skills.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, students who have completed 12th grade can join the Ethical Hacking course.",
    },
    {
      question: "What are the benefits of learning Ethical Hacking?",
      answer: "Ethical hacking skills help you secure systems, prevent cyber attacks, and pursue a career in cybersecurity.",
    },
  ];
  ...
  return (
    <div className="bg-gray py-10 px-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold">FAQs About Online Ethical Hacking Course</h2>
...
export default FAQSectionEthicalHacking;
