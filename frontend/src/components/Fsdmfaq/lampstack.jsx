...
const FAQSectionLAMP = () => {
  ...
  const faqs = [
    {
      question: "What is the LAMP Stack Development course?",
      answer:
        "The LAMP Stack course covers Linux, Apache, MySQL, and PHP to build dynamic web applications.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, a certificate will be awarded upon successfully completing the LAMP Stack course.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, students who have completed 12th grade can join the LAMP Stack Development course.",
    },
    {
      question: "What are the benefits of learning LAMP Stack Development?",
      answer: "It helps you build scalable web applications, opens career opportunities, and enhances your backend development skills.",
    },
  ];
  ...
  return (
    <div className="bg-gray py-10 px-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold">FAQs About Online LAMP Stack Development Course</h2>
