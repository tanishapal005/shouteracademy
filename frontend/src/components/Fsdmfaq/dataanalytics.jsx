...
const FAQSectionDataAnalytics = () => {
    ...
    const faqs = [
      {
        question: "What is the Data Analytics course about?",
        answer:
          "The Data Analytics course teaches you how to analyze, interpret, and visualize data using tools like Python, SQL, Excel, and Power BI.",
      },
      {
      ...
      },
      {
        ...
        answer: "No, prior coding experience is not required, but basic Excel or programming knowledge is helpful.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes, students who have completed 12th grade can join the Data Analytics course.",
      },
      {
        question: "What are the benefits of learning Data Analytics?",
        answer: "Data Analytics skills are in high demand, offering career opportunities in business intelligence, finance, healthcare, and more.",
      },
    ];
    ...
    return (
      <div className="bg-gray py-10 px-6">
        ...
        <div className="text-center mb-6">
          <h2 className="text-xl font-bold">FAQs About Online Data Analytics Course</h2>
...
export default FAQSectionDataAnalytics;
