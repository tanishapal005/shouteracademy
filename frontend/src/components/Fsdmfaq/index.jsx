  ...
  const faqs = [
    {
      ...
      answer:
        "A digital marketing course is skill-based training covering SEO, SMM, Google Ads, PPC, and more.",
    },
    {
    ...
    {
      question: "Is it a digital marketing course with placement assistance?",
      answer: "Yes, placement assistance is provided for eligible students.",
    },
    {
      question: "Can I do digital marketing course after 12th?",
      answer: "Yes, students after 12th can enroll in a digital marketing course.",
    },
    {
      question: "What are the benefits of learning digital marketing?",
      answer: "It helps in career growth, better job opportunities, and freelancing options.",
    },
  ];
  ...
  return (
    <div className="bg-gray py-10 px-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold">FAQs About Online Digital Marketing Course</h2>
