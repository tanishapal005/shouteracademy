...
const FAQSectionVideoEditing = () => {
    ...
    const faqs = [
      {
        question: "What is the Video Editing course about?",
        answer:
          "The Video Editing course covers fundamental editing techniques, software tools, transitions, effects, and professional post-production skills.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes, a certificate will be awarded upon successfully completing the Video Editing course.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes, students who have completed 12th grade can join the Video Editing course.",
      },
      {
        question: "What are the benefits of learning Video Editing?",
        answer: "It helps you create engaging videos, enhance storytelling skills, and opens up career opportunities in media, film, and content creation.",
      },
    ];
    ...
    return (
      <div className="bg-gray py-10 px-6">
        ...
        <div className="text-center mb-6">
          <h2 className="text-xl font-bold">FAQs About Online Video Editing Course</h2>
  ...
  export default FAQSectionVideoEditing;
