...
const FAQSectionMERN = () => {
  ...
  const faqs = [
    {
      question: "What is the MERN Stack Development course?",
      answer:
        "The MERN Stack course covers MongoDB, Express.js, React.js, and Node.js to build full-stack web applications.",
    },
    {
    ...
    },
    {
      ...
      answer: "Recorded sessions will be available to help you catch up on missed content.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, a certificate will be awarded upon successfully completing the MERN Stack course.",
    },
    {
      question: "Can I attend a demo class before enrolling?",
      answer: "Yes, a free demo class is available to help you decide before enrolling.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, students who have completed 12th grade can join the MERN Stack Development course.",
    },
    {
      question: "What are the benefits of learning MERN Stack Development?",
      answer: "It helps you become a full-stack developer, opens career opportunities, and enables you to build scalable web applications.",
    },
  ];
  ...
  return (
    <div className="bg-gray py-10 px-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold">FAQs About Online MERN Stack Development Course</h2>
