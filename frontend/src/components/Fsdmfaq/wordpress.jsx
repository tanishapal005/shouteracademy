...
const FAQSectionWordPress = () => {
  ...
  const faqs = [
    {
      question: "What is the WordPress Development course?",
      answer:
        "The WordPress Development course teaches you how to create, customize, and manage websites using WordPress.",
    },
    {
    ...
    {
      question: "Do I need coding knowledge to learn WordPress?",
      answer: "No, WordPress allows you to build websites without coding, but learning HTML, CSS, and PHP can help.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, students who have completed 12th grade can join the WordPress Development course.",
    },
    {
      question: "What are the benefits of learning WordPress Development?",
      answer: "WordPress is a powerful CMS that helps you build websites, blogs, and eCommerce stores with ease.",
    },
  ];
  ...
  return (
    <div className="bg-gray py-10 px-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold">FAQs About Online WordPress Development Course</h2>
...
export default FAQSectionWordPress;
