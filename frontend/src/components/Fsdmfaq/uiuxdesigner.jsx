...
const FAQSectionUIUX = () => {
  ...
  const faqs = [
    {
      question: "What is the UI/UX Designer course?",
      answer:
        "The UI/UX Designer course covers user research, wireframing, prototyping, usability testing, and designing engaging user experiences.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, a certificate will be awarded upon successfully completing the UI/UX Designer course.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, students who have completed 12th grade can join the UI/UX Designer course.",
    },
    {
      question: "What are the benefits of learning UI/UX Design?",
      answer: "It helps you create user-friendly interfaces, improve problem-solving skills, and prepares you for careers in web, app, and product design.",
    },
  ];
  ...
  return (
    <div className="bg-gray py-10 px-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-xl font-bold">FAQs About Online UI/UX Designer Course</h2>
